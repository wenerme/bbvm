...
func DecodeConfig(r io.ReadSeeker) (configs []Config, err error) {
	_, configs, err= decodeImage(r, false)
	return
}
...
func decodeImage(r io.ReadSeeker, decodeImages bool) (images []image.Image, configs []Config, err error) {
	pos, err := r.Seek(0, os.SEEK_CUR)
	if err != nil {return }
	f, err := detectImageFormat(r)
	if err != nil {return }
	_, err = r.Seek(pos, os.SEEK_SET)
	if err != nil {return }
